...
<body>
  <h2>SHAIKH ESP8266 DHT Server</h2>
  <p>
  ...
  <p> 
    <i class="fa-light fa-ruler-horizontal" style="color:#fc4e4e;"></i>
...
setInterval(function ( ) {
  ...
  xhttp.onreadystatechange = function() {
    if (this.readyState == 4 && this.status == 200) {
      document.getElementById("ultra").innerHTML = this.responseText;
    }
  };
